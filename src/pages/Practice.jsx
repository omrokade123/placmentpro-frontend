...
// ── Configs moved OUTSIDE the component — were incorrectly inside before ──────
...
export const testTypeConfig = {
  aptitude: {
    ...
    title: "Aptitude Test",
    desc: "Quantitative aptitude & numerical problem solving",
  },
  reasoning: {
    icon: Brain,
    ...
    desc: "Pattern recognition, puzzles, and logical thinking",
  },
  verbal: {
    icon: MessageCircle,
    ...
    desc: "English comprehension, grammar, and vocabulary",
  },
  coding: {
    icon: Code,
    ...
    title: "Coding Test",
    desc: "Data structures, algorithms, and programming challenges",
  },
};
...
export default function Practice() {
  ...
  const [testTopic, setTestTopic]           = useState("aptitude");
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      console.error("GEN ERROR:", err.response?.data || err);
  ...
  const currentTestType  = testTypeConfig[testTopic];
  const currentDifficulty = difficultyConfig[difficulty];
  const currentQuestions  = questionsOptions.find((o) => o.value === totalQuestions);
      ...
      <div className="max-w-5xl mx-auto space-y-6 md:space-y-8">
        ...
        <div className="relative overflow-hidden rounded-2xl md:rounded-3xl bg-linear-to-br from-purple-600 via-indigo-600 to-blue-600 p-6 md:p-12 shadow-2xl">
          <div className="absolute inset-0 opacity-20">
            <div className="absolute top-0 right-0 w-64 md:w-96 h-64 md:h-96 bg-white rounded-full blur-3xl animate-pulse" />
            <div className="absolute bottom-0 left-0 w-64 md:w-96 h-64 md:h-96 bg-white rounded-full blur-3xl animate-pulse delay-1000" />
          </div>
            ...
            <CardContent className="p-4 md:p-6 relative z-10">
              <div className="flex items-start justify-between">
                <div className="space-y-1 md:space-y-2 flex-1">
                  ...
                  <div>
                    <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 font-medium">Difficulty Level</p>
            ...
            <CardContent className="p-4 md:p-6 relative z-10">
              <div className="flex items-start justify-between">
                <div className="space-y-1 md:space-y-2 flex-1">
                  ...
                  <div>
                    <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 font-medium">Total Questions</p>
            ...
            <CardContent className="p-4 md:p-6 relative z-10">
              <div className="flex items-start justify-between">
                <div className="space-y-1 md:space-y-2 flex-1">
                  ...
                  <div>
                    <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 font-medium">Estimated Time</p>
        ...
        <Card className="rounded-2xl md:rounded-3xl border-2 border-gray-200 dark:border-gray-800 shadow-xl overflow-hidden">
          <div className="bg-linear-to-r from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 p-5 md:p-8 border-b border-gray-200 dark:border-gray-800">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">Test Configuration</h2>
                <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400">Customize your practice experience</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-5 md:p-8 space-y-6 md:space-y-8">
            ...
            <div className="space-y-3 md:space-y-4">
              <div className="flex items-center gap-3">
                ...
                <label className="text-base md:text-lg font-bold text-gray-900 dark:text-white">Test Type</label>
              </div>
              ...
              <div className="w-full p-4 md:p-5 border-2 border-gray-300 dark:border-gray-700 rounded-xl md:rounded-2xl bg-white dark:bg-gray-900 shadow-sm">
                <div className="flex items-center gap-3 md:gap-4">
                  ...
                  <div className="text-left flex-1 min-w-0">
                    <p className="font-bold text-base md:text-lg text-gray-900 dark:text-white">{currentTestType.title}</p>
                    <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400">{currentTestType.desc}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {Object.entries(testTypeConfig).map(([key, config]) => {
                  ...
                  const isSelected = testTopic === key;
                  return (
                    <button
                      key={key}
                      onClick={() => setTestTopic(key)}
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                          <p className="font-bold text-sm text-gray-900 dark:text-white">{config.title}</p>
            ...
            <div className="space-y-3 md:space-y-4">
              <div className="flex items-center gap-3">
                ...
                <label className="text-base md:text-lg font-bold text-gray-900 dark:text-white">Difficulty Level</label>
              </div>
              ...
              <div className="w-full p-4 md:p-5 border-2 border-gray-300 dark:border-gray-700 rounded-xl md:rounded-2xl bg-white dark:bg-gray-900 shadow-sm">
                <div className="flex items-center gap-3 md:gap-4">
                  ...
                  <div className="text-left flex-1 min-w-0">
                    <p className="font-bold text-base md:text-lg capitalize text-gray-900 dark:text-white">{difficulty}</p>
                    <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400">{currentDifficulty.tagline}</p>
                  </div>
                </div>
              </div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex flex-col items-center gap-2 text-center">
                        ...
                        <div>
                          <p className="font-bold capitalize text-sm text-gray-900 dark:text-white">{key}</p>
                          <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{config.tagline}</p>
                        </div>
                        {isSelected && (
            ...
            <div className="space-y-3 md:space-y-4">
              <div className="flex items-center gap-3">
                ...
                <label className="text-base md:text-lg font-bold text-gray-900 dark:text-white">Number of Questions</label>
              </div>
              ...
              <div className="w-full p-4 md:p-5 border-2 border-gray-300 dark:border-gray-700 rounded-xl md:rounded-2xl bg-white dark:bg-gray-900 shadow-sm">
                <div className="flex items-center gap-3 md:gap-4">
                  <div className="w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl md:rounded-2xl flex items-center justify-center shadow-lg flex-shrink-0">
                    <span className="font-bold text-white text-2xl md:text-3xl">{totalQuestions}</span>
                  </div>
                  <div className="text-left flex-1 min-w-0">
                    <p className="font-bold text-base md:text-lg text-gray-900 dark:text-white">{totalQuestions} Questions</p>
                    ...
                    >
                      <div className="flex flex-col items-center gap-2">
                        <div className="w-12 h-12 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-lg flex items-center justify-center shadow-md">
                          <span className="font-bold text-white text-xl">{option.value}</span>
                        </div>
                        <div>
                          <p className="font-bold text-sm text-gray-900 dark:text-white">{option.value} Qs</p>
            ...
            <div className="relative overflow-hidden rounded-xl md:rounded-2xl bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-blue-950/30 dark:via-indigo-950/30 dark:to-purple-950/30 border-2 border-blue-200 dark:border-blue-800 p-4 md:p-6">
              <div className="absolute top-0 right-0 w-24 h-24 md:w-32 md:h-32 bg-white/30 dark:bg-white/5 rounded-full blur-2xl" />
